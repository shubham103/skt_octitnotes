		...
		<div class="w3-container w3-center">
			...
			<div class="w3-card-4 w3-center w3-hide-small w3-large-medium" style="width:100%">
				...
				<form action="signup.php" method="post">
					<br/><br/>
					<div class="w3-display-container"><input class="w3-input w3-display-middle w3-center" name="name" type="text" placeholder="full name" required style="max-width:300px;" ><br/><br/><br/></div>
					...
					<div class="w3-display-container"><input class="w3-input w3-display-middle w3-center" style="max-width:300px;" name="password" type="password" placeholder="password" required><br/><br/><br/></div>
					<input class="w3-button w3-green" name="submit" type="submit" value="CREATE">
					<br/>
					<a href="loginportal.php" class="w3-text-blue w3-hover-text-white"><h4>Login</h4></a>
				</form>
				</div>
			...
			<div class="w3-card-4 w3-center w3-hide-medium w3-hide-large" style="width:100%">
				...
				<form action="signup.php" method="post">
					<br/>
					<input class="w3-input  w3-center" name="name" type="text" placeholder="full name" required ><br/>
